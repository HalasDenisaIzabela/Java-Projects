...
class DiferentaTest {
    ...
    void difPol() {
        ...
        assertEquals("1.0x^2 + 5.0x^1 + -1.0", o.difPol(p1, p2).toString());
        assertEquals("-1.0x^3 + 2.0", o.difPol(p3, p4).toString());
        assertNotEquals("2.0x^2 + -1.5", o.difPol(p2, p3).toString());
    }
}